  ...
  return (
    <div className='about'>
        ...
        <div className="about-right">
            ...
            <p>Embark on a tranformative educational journey with our university's comprehensive education programs. Our cutting-edge curriculum is designed to empower students with the dynamic field of education.</p>
